...
STRING_LISTS = []
for i in range(1,25):
    globals()[f"STRING{i}_VOLTAGE"] = f"dcVoltage{i}"
    globals()[f"STRING{i}_CURRENT"] = f"dcCurrent{i}"
    globals()[f"STRING{i}_POWER"] = f"dcPower{i}"
    STRING_LISTS.append([
...
BACKUP_TODAY_ENERGY = "backupTodayEnergy"
